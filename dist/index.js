...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield axios_1.default.post(EVALUATION_API_URL, {
            ...
            if (detail === 'missing_authorization_header') {
                core.setFailed(`Missing API Key. Please provide a valid Orquesta API Key.`);
            }
            if (detail === 'invalid_api_key') {
                core.setFailed(`Failed to authenticate with the Orquesta Evaluation API. Check your API Key.`);
            }
